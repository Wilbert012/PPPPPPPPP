...
3. In the PPPPPPPPP project, open the `PPPPPPPPP`  folder, then open the `fleet`  subfolder, rename the `fleet` subfolder into the `.fleet` subfolder, and then select the `run.json` file and click on the "Run" button.
